...
const experiences = [
  {
    ...
    points: [
      "Developed a reservation management web application using MongoDB, ExpressJS, ReactJS, NodeJS, HTML, CSS, and JavaScript, optimizing table booking efficiency.",
      "Increased efficiency by providing real-time visual representation of reservations for each day, enabling the restaurant staff to optimize table occupancy and minimize wait times.",
